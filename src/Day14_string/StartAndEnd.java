...
public class StartAndEnd {
    public static void main(String[] args) {
        ...
        System.out.println( str.toLowerCase().startsWith("loop".toLowerCase()) );// ignore case
        ...
        System.out.println(str.startsWith(" Loop")); // space in here false
        System.out.println(str.startsWith(     "Loop"));// true
        ...
        // System.out.println(str.startsWith('L')); //This is char
        // System.out.println('L'.startsWith("L")); //This is char
    }
}
