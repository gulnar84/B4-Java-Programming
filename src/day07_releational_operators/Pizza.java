...
public class Pizza {
    public static void main(String[] args) {
        ...
        int slicesForEachPerson = numOfSlices / numOfPeople; //divided 20/6=3|2 we take 3 when divided
        // int slicesLeftOver = numOfSlices - (numOfPeople * slicesForEachPerson); // Another way to get the correct result
        int slicesLeftOver = numOfSlices % numOfPeople;// % 20/6=3\2 we take 2 remainder
