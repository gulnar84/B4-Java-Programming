...
// Jva hello Bye our words teacher enter
        boolean isFirstLongestWithA = word1.contains("a") && ( word1.length() > word2.length() && word1.length() > word3.length() );// word 1 contains--True--word1>word2  false---word1>word3  False---T-&&-F-&&-F is false
        boolean isSecondLongestWithA = word2.contains("a") && word2.length() > word1.length() && word2.length() > word3.length();// word2 contains a  false
