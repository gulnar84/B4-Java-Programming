...
import java.util.Scanner;//scanner class is in java util package

public class StringMemory {  // string memory class day13_string  package
    public static void main(String[] args) {
// datatype (non-primitive /Object Type)
        // Scanner key; -ClassName objectReferenceName
        Scanner key;
        String word;
