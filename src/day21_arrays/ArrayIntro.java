...
public class ArrayIntro {
    public static void main(String[] args) {
       ...
       // String[] cities;
        // OPTION 1- declare and assign values directly | 4 elements are added-- meaning size is 4

        String[] cities1={"Chicago" ," Fairfax"," NewYork", " Boston"};
        // String [] cuties1= {city1, city2, city3, city4}; // Instead hard coded values, we can use variables as well
        // OPTION 2- declare array with size only
